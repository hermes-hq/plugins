import { DEFAULT_NEUTRAL_COLOR } from '../engine/constants';
import { getCatalogEntry, getRotatedType, getToggledType } from './furnitureCatalog';
import { getPlacementBlockedTiles } from './layoutSerializer';
import type {
  FloorColor,
  OfficeLayout,
  PlacedFurniture,
