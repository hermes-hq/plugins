...
import { getColorizedFloorSprite, hasFloorSprites, WALL_COLOR } from '../office/floorTiles';
...
import { CharacterState, TILE_SIZE, TileType } from '../office/types';
import { getWallInstances, hasWallSprites, wallColorToHex } from '../office/wallTiles';
